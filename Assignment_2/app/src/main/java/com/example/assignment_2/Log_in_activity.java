                    ...
                    firebaseAuth.signInWithEmailAndPassword(email, password_Str).addOnCompleteListener(Log_in_activity.this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(!task.isSuccessful()) {
                                Toast.makeText(Log_in_activity.this, "Log in error, please try again.", Toast.LENGTH_SHORT);
                            }
                            else {
                                Toast.makeText(Log_in_activity.this, "Log in successfully!", Toast.LENGTH_SHORT);
                                finish();
                            }
                        }
                    });
