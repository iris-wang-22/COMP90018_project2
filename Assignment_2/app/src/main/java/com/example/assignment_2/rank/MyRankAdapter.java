...
public class MyRankAdapter extends BaseAdapter {
    ...
    private List<rankMode> mData;
    private ViewHolder holder = null;

    MyRankAdapter(Context context, List data){
